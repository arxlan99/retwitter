...
const ContentCard = (props: Props) => {
  return (
    <div className="bg-[#F7F9F9] rounded-2xl overflow-hidden">
      <div className="font-bold text-xl py-3 px-4 tracking-wide">
        What's happening
      </div>
      <div className="py-3 px-4 flex flex-col gap-.5 hover:bg-defaultHover transition-all cursor-pointer">
        <div className="text-xs text-[#536471]">Politics</div>
        <div className="font-bold">
          Image of Dr. Oz campaign poster was digitally altered, fact-checkers
          say
        </div>
      ...
      <div className="py-3 px-4 flex flex-col gap-.5 hover:bg-defaultHover transition-all cursor-pointer text-[15px]">
